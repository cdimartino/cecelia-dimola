<template>
  <ul>
    ...
    <li>
      <NuxtLink to="/celebration-of-life">
        <span class="icon">
    ...
    <li>
      <NuxtLink to="/video">
        <span class="icon">
          <svg class="svg-inline--fa fa-video fa-w-18 fa-fw" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <span class="menu">A Tribute to Cecelia</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/story">
        <span class="icon">
          <svg class="svg-inline--fa fa-book fa-w-18 fa-fw" aria-hidden="true" focusable="false" data-prefix="fas"
            data-icon="images" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
            <path fill="currentColor"
        ...
        <span class="menu">Celia's Story</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/gallery">
    ...
    <li>
      ...
      <span class="menu">Donate to help end Parkinson's Disease</span>
    </NuxtLink>
  </li>
</ul></template>
